...
describe('Testing Candidate Class', (): void => {
  ...
  it('Must modify the number correctly', (): void => {
    const candidate: Candidate = new Candidate('Jose', '01232');
